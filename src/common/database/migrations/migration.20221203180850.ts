...
export class Migration20221203180850 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "phones" add constraint "phones_collaborator_id_foreign" foreign key ("collaborator_id") references "collaborators" ("id") on update cascade on delete cascade;');

    this.addSql('alter table "addresses" add constraint "addresses_collaborator_id_foreign" foreign key ("collaborator_id") references "collaborators" ("id") on update cascade on delete cascade;');
