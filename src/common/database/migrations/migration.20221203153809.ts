...
export class Migration20221203153809 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "collaborators" ("id" uuid not null default uuid_generate_v4(), "created_at" timestamptz(0) not null default now(), "updated_at" timestamptz(0) not null default now(), "deleted_at" timestamptz(0) null, "code" varchar(8) null, "cpf" varchar(14) null, "rg" varchar(18) null, "birth_date" timestamptz(0) null, "role" varchar(255) null, "job" varchar(100) null, "sex" text check ("sex" in (\'male\', \'female\', \'not_informed\')) not null default \'not_informed\', "work_type" text check ("work_type" in (\'clt\', \'pj\', \'freelancer\', \'internship\', \'not_informed\')) not null default \'not_informed\', "status" text check ("status" in (\'active\', \'inactive\')) not null default \'active\', "civil_status" text check ("civil_status" in (\'single\', \'married\', \'divorced\', \'widowed\', \'not_informed\')) not null default \'not_informed\', "description" text null, "user_id" uuid null, constraint "collaborators_pkey" primary key ("id"));',
    );
    this.addSql(
