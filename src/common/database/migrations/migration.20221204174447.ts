...
export class Migration20221204174447 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "phones_collaborators" ("id" uuid not null default uuid_generate_v4(), "collaborator_id" uuid null, "phone_id" uuid null, "assigned_at" timestamptz(0) not null default now(), constraint "phones_collaborators_pkey" primary key ("id", "collaborator_id", "phone_id"));');
    this.addSql('comment on table "phones_collaborators" is \'PhoneEntity Collaborator Pivot Table\';');

    this.addSql('create table "addresses_collaborators" ("id" uuid not null default uuid_generate_v4(), "collaborator_id" uuid null, "address_id" uuid null, "assigned_at" timestamptz(0) not null default now(), constraint "addresses_collaborators_pkey" primary key ("id", "collaborator_id", "address_id"));');
    this.addSql('comment on table "addresses_collaborators" is \'AddressCollaboratorEntity Pivot Table\';');
